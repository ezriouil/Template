              ...
              return [
                ...
                SliverAppBar(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                        onTap: () {},
                        child: Icon(Iconsax.bag_24, color: darkLightColor(context))),
                  ),
                   Positioned(
              ...
              child: Column(
                ...
                children:[
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(flex: 6,child: CustomTextField(
                         ...
                         Expanded(child: InkWell(onTap: controller.showFilterBottomSheet, child: const Icon(Iconsax.filter, size: 30)))
                      ],
                    ),
                  ),
                  CustomGridView(
                      ...
                      itemBuilder:
                          ...
                          CustomProductVertical(
                            ...
                            product: Product(
                                ...
                                price: 200,
                                oldPrice: 250,
                                thumbnail1: "https://contents.mediadecathlon.com/p2436315/e957bd6a23553ffabaef22fd550e99c3/p2436315.jpg?format=auto&quality=70&f=650x0"),
