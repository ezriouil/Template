      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            // - - - - - - - - - - - - - - - - - - MINUS BUTTON - - - - - - - - - - - - - - - - - -  //
            InkWell(
              onTap: controller.decrementTheCounter,
            ...
            // - - - - - - - - - - - - - - - - - - ADD BUTTON - - - - - - - - - - - - - - - - - -  //
            InkWell(
              onTap: controller.incrementTheCounter,
              borderRadius: BorderRadius.circular(50),
              child: Container(
                decoration: BoxDecoration(
                    color: darkLightColor(context).withOpacity(0.4),
                    borderRadius: BorderRadius.circular(50)),
                padding: const EdgeInsets.all(6.0),
                child: const Icon(
                  Iconsax.add,
            ...
            Expanded(
              child: CustomElevatedButton(
                text: "Add to Bag",
                onClick: controller.onAddToBag,
                width: getWidth(context),
                style: ElevatedButton.styleFrom(
                    shadowColor: darkLightColor(context),
                    backgroundColor: darkLightColor(context).withOpacity(0.4),
