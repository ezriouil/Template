...
import 'package:test1/features/location_address/screens/mobile/mobile_add_new_location_address_screen.dart';
import 'package:test1/features/location_address/screens/tablet/tablet_add_new_location_address_screen.dart';
import 'package:test1/features/location_address/screens/web/web_add_new_location_address_screen.dart';
import 'package:test1/utils/device/device_utility.dart';
import 'package:test1/utils/local/database/app_database.dart';

class LocationAddressController extends GetxController {
  // - - - - - - - - - - - - - - - - - - CREATE STATES - - - - - - - - - - - - - - - - - -  //
  ...
  Future<void> onNavigateToInsertAddressScreen(DeviceType deviceType) async {
    switch (deviceType) {
      case DeviceType.MOBILE:
        Get.to(() => const MobileAddNewLocationAddressScreen());
      case DeviceType.TABLE:
        Get.to(() => const TabletAddNewLocationAddressScreen());
      case DeviceType.WEB:
        Get.to(() => const WebAddNewLocationAddressScreen());
    }
  }
